...
import 'package:project_upgrader/src/command_runner.dart';
...
void main() {
  group('ProjectUpgraderCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late ProjectUpgraderCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = ProjectUpgraderCommandRunner(
        logger: logger,
    ...
    test(
      ...
      () {
        final commandRunner = ProjectUpgraderCommandRunner();
